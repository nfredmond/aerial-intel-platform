...
- blocked state with support contact + prefilled support diagnostics (user/org identifiers, role, membership, entitlement), a one-click copy action, and a ready-to-copy manual fallback text box when clipboard access is unavailable
