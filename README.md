...
- `/missions` protected Aerial Operations OS workspace shell with visual mission readiness strips and a GIS triage board for priority queue + delivery posture
