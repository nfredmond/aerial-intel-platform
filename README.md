...
- `/missions` protected Aerial Operations OS workspace shell with visual mission readiness strips, a GIS triage board, and client-side mission search/stage/risk filtering
