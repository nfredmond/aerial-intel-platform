...
- blocked state with support contact + prefilled support diagnostics (user/org identifiers, role, membership, entitlement) when user is signed in but not entitled
