...
- blocked state with support contact + prefilled support diagnostics (user/org identifiers, role, membership, entitlement) and a one-click copy action when user is signed in but not entitled
